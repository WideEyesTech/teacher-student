"""Unit testing of FaceKeypointsDataset
"""
...
from dataset.face_keypoints_dataset import FaceKeypointsDataset
...
class BasicDataLaoderTests(TestCase):
    ...
    def test_len(self):
        ...
        with mock.patch('os.listdir') as mocked_listdir:
            ...
            data_loader = FaceKeypointsDataset('/fake/path', '/fake/path', 'train')
